...
const argv = yargs(hideBin(process.argv))
  ...
  .option('patterns', { type: 'string', describe: 'Regex for error detection', default: '(error|exception|panic|fatal|segfault|stack trace|traceback|unhandled|critical|ERR!)' })
